...
// + double buffer + resolve bank conflict
#ifndef GEMM_V6_CUH
#define GEMM_V6_CUH
...
__global__ void gemm_v6_kernel(float *__restrict__ A, float *__restrict__ B,
...
template <int TILE_SIZE_M, int TILE_SIZE_N, int BLOCK_SIZE_M, int BLOCK_SIZE_N,
          int BLOCK_SIZE_K, int M, int N, int K>
void gemm_v6(const float *A, const float *B, float *C) {
  ...
  // Launch kernel
  gemm_v6_kernel<TILE_SIZE_M, TILE_SIZE_N, BLOCK_SIZE_M, BLOCK_SIZE_N,
